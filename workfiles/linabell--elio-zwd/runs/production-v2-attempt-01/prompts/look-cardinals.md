Create one horizontal four-cardinal anchor strip for Codex pet `linabell-elio-zwd`.
...
Place one pose in each invisible equal-width slot on a flat pure user-selected #6A00FF background with generous padding. Keep scale, feet/base, lower body, and registration consistent across all four slots.
